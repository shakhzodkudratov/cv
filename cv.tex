...
GitHub: \href{https://github.com/aeshakhzod/}{github.com/aeshakhzod} \\
LinkedIn: \href{https://linkedin.com/in/shakhzodkudratov/}{linkedin.com/in/shakhzodkudratov}

\bigskip
Software engineer with more than 6 years of commercial experience.
...
\begin{itemize}[leftmargin=*]
  \item[] \textbf{Lead Software Engineer}, \href{https://www.linkedin.com/company/uzinfocom/}{Single integrator - UZINFOCOM" LLC} \hfill
    \small{May 2026 - Present}
  \begin{itemize} \setlength{\itemsep}{1pt} \setlength{\parskip}{1pt}
    \item Working on a Gartensia project. WebAssembly based platform for security first and plugin based applications.
  \end{itemize}

  \item[] \textbf{Software Engineer}, \href{https://www.linkedin.com/company/domo-uzbekistan/}{DOMO} \hfill
    \small{Feb 2026 - May 2026}
  \begin{itemize} \setlength{\itemsep}{1pt} \setlength{\parskip}{1pt}
    \item Maintained Webview and Backoffice parts
  \end{itemize}

  \item[] \textbf{Lead Software Engineer}, \href{https://www.linkedin.com/company/uzinfocom/}{Single integrator - UZINFOCOM" LLC} \hfill
    \small{Feb 2023 - Feb 2026}
  \begin{itemize} \setlength{\itemsep}{1pt} \setlength{\parskip}{1pt}
    ...
    \item Worked on \href{https://xinux.uz}{xinux.uz} operating system and on an ecosystem around it.
    \item Worked on \href{https://uchar.uz}{uchar.uz} messenger based on a Matrix protocol.
  \end{itemize}
